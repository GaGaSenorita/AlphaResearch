...
config=configs/ldm_rankic_turnover_ehvi/ldm_rankic_turnover_ehvi_deepseek-v4-pro_2016-2025.yaml
log_dir="$repo/runtime/logs/ldm_rankic_turnover_ehvi"
...
for seed in "$@"; do
  out="$repo/runs/ldm_rankic_turnover_ehvi/ldm_rankic_turnover_ehvi_deepseek-v4-pro_2016-2025_seed${seed}"
  if [[ -e "$out" ]]; then
