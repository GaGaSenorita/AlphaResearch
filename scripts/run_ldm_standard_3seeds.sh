...
config=configs/ldm_standard/ldm_standard_deepseek-v4-pro_2016-2025.yaml
log_dir="$repo/runtime/logs/ldm_standard"
...
for seed in "$@"; do
  out="$repo/runs/ldm_standard/ldm_standard_deepseek-v4-pro_2016-2025_seed${seed}"
  if [[ -e "$out" ]]; then
